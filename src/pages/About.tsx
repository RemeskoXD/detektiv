      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-12 lg:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 sm:mb-10">
          <div className="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 sm:p-10 flex flex-col items-start">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold text-[#1A1A1A] mb-4 tracking-tight">Odborné členství</h3>
          ...
          <div className="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 sm:p-10 flex flex-col items-start">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold text-[#1A1A1A] mb-4 tracking-tight">Naprostá diskrétnost</h3>
            <p className="text-gray-600 leading-relaxed text-[1.05rem]">
        ...
        <div className="bg-white rounded-[2rem] sm:rounded-[3rem] shadow-[0_4px_24px_rgb(0,0,0,0.02)] p-10 sm:p-16 mb-20 text-center">
            <h3 className="text-2xl sm:text-3xl font-semibold text-[#1A1A1A] tracking-tight mb-6">Můj přístup</h3>
        ...
        <div className="flex flex-col items-center justify-center text-center mt-12">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full sm:w-auto">
            <a href="tel:+420602776025" className="w-full sm:w-auto px-8 py-4 bg-[#1A1A1A] text-white rounded-full font-medium text-[1.05rem] hover:bg-gray-800 transition-colors shadow-sm">
              Zavolat +420 602 776 025
            </a>
            <a href="mailto:vladimir@profesionalnidetektiv.cz" className="w-full sm:w-auto px-8 py-4 bg-white text-[#1A1A1A] border border-gray-200 rounded-full font-medium text-[1.05rem] hover:bg-gray-50 transition-colors shadow-sm">
              Napsat e-mail
            </a>
          </div>
        </div>
